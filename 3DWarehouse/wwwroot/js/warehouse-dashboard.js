...
(function () {
  ...
  // Route có {warehouseId} — view tiêm window.PMC_WAREHOUSE_ID/PMC_WAREHOUSE_NAME (xem Map.cshtml)
  // để 1 bộ script này dùng chung cho mọi kho thay vì hard-code tên/route riêng cho PMC.
  ...
  function applyStaticTranslations() {
    ...
    setTxt('wh3d-banner-title', WH_NAME || I18N.t('bannerTitle'));
  ...
  function loadDashboard() {
    fetch('Warehouse/' + WH_ID + '/Dashboard').then(function (r) { return r.json(); }).then(function (d) {
      if (!d) return;
      var s = d.summary || {};
